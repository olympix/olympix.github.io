...
See the [SSO Setup Guide](/cli/sso/) for detailed instructions.
...
- User downloads CLI following the [Installation Guide](/installation/)
...
- **[SSO Setup](/cli/sso/)** - Configure Okta Single Sign-On
