...
The TUI requires an interactive terminal (not piped output). If you need non-interactive automation, see [Agent Mode](./Agent%20Mode.md).
...
| `olympix bug-pocer` | BugPocer session manager — see [BugPoCer docs](./BugPoCer.md) |
...
- **[Agent Mode](./Agent%20Mode.md)** — non-interactive JSON protocol for AI agent integrations
- **[BugPoCer](./BugPoCer.md)** — detailed BugPoCer documentation
- **[Analysis](./Analysis.md)** — static analysis and reporting
- **[Unit Test Generation](./Unit%20Testing.md)** — unit test generation guide
- **[Mutation Test Generation](./Mutation%20Testing.md)** — mutation test generation guide
