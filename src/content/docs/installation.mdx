...
<Code lang="bash" code={`# macOS / Linux
...
| Platform | SHA-256 |
| --- | --- |
| `osx-arm64`   | <code>{CLI_BINARIES['osx-arm64'].sha256}</code> |
| `osx-x64`     | <code>{CLI_BINARIES['osx-x64'].sha256}</code> |
| `linux-arm64` | <code>{CLI_BINARIES['linux-arm64'].sha256}</code> |
| `linux-x64`   | <code>{CLI_BINARIES['linux-x64'].sha256}</code> |
| `win-arm64`   | <code>{CLI_BINARIES['win-arm64'].sha256}</code> |
| `win-x64`     | <code>{CLI_BINARIES['win-x64'].sha256}</code> |
