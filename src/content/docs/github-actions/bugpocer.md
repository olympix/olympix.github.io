---
title: BugPoCer GitHub Action
description: Run BugPoCer in CI on pull requests.
---
...
BugPocer is the agentic counterpart to the static [Integrated Security](/github-actions/integrated-security/)
...
:::caution[Workflow file must live on the default branch]
